...
Tarvittavat kirjastot (python 3.10.19)

## Py-torch

pip install torch torchvision torchaudio --index-url https://download.pytorch.org/whl/cu118 //Vaatii siis cudan tietokoneelta opetukseen.
